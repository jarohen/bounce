(ns multi-page.service.main
  (:require [multi-page.service.cljs :as cljs]
            [multi-page.service.handler :refer [make-handler]]
...
(defn -main []
  ...
  (bc/set-system-map-fn! 'multi-page.service.main/make-system-map)
